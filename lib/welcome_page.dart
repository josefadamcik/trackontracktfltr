...
class _MyWelcomePageState extends State<WelcomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    var underlinedStyle = defaultTextStyle.copyWith(decoration: TextDecoration.underline, color: theme.accentColor);
    ...
    return new Scaffold(
      ...
      body: new Column(
          ...
          children: <Widget>[
            new Padding(padding: new EdgeInsets.symmetric(horizontal: 16.0, vertical: 32.0),
              child: new Row(
  ...
  Container _buildWelcomeText(TextStyle defaultTextStyle, TextStyle underlinedStyle) {
    return new Container(
            ...
            child: new RichText(
              ...
              text: new TextSpan(
                text: "TrackOnTrakt is an opensource Android application for tracking your watched movies and shows on the ",
                ...
                children: <TextSpan>[
                  ...
                  new TextSpan(
                    style: defaultTextStyle,
                    text: ' website. You need a trakt.tv account in order to use it.'
                  )
                ]
              ),
            ),
